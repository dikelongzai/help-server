...
//                            alert(act);
//                            alert(ajax_branch);
//                            $.get("{:U('admin/Goods/updateClassByGcSort')}",{branch:ajax_branch,id:s_id,column:s_name,value:$(this).attr('value')},function(data){
//                                if(data === 'false')
//                                {
//                                    alert('名称已经存在，请您换一个');
...
//                            });
					...
					$(this).prev('span').show().text($(this).attr('value'));
					$.get(ajax_branch,{branch:ajax_branch,id:s_id,column:s_name,value:$(this).attr('value')},function(data){
						if(data === 'false')
							{
								alert('名称已经存在，请您换一个');
								$('span[fieldname="'+s_name+'"][fieldid="'+s_id+'"]').text(s_value);
...
//		$.get("{:U('admin/Goods/updateClassByGcSort')}",{branch:ajax_branch,id:i_id,column:i_name,value:i_val},function(data){
//		if(data == 'true')
//			{
//				if(i_val == 0){
